      ...
      snapshot.forEach((doc) => {
        ...
        if (data.created) {
          if (typeof data.created === 'number') {
            createdDate = new Date(data.created * 1000);
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="flex items-center justify-between mb-4">
                  ...
                  {mrrChange !== 0 && (
                    <div className={`flex items-center gap-1 text-sm font-medium ${
                      ...
                      {mrrChange > 0 ? <TrendingUp className="h-4 w-4" /> : <TrendingDown className="h-4 w-4" />}
              ...
              <div className="bg-white rounded-xl border p-6 hover:shadow-lg transition-shadow">
                ...
                <div>
                  ...
                  <p className="text-3xl font-bold text-gray-900">{failedInvoices.length}</p>
                  <p className="text-xs text-gray-500 mt-1">Requires attention</p>
                </div>
              </div>
            </div>

            {/* Revenue Breakdown & Failed Payments */}
              ...
              {failedInvoices.length > 0 && (
                <div className="bg-white rounded-xl border border-red-200 p-6">
                  <div className="flex items-start gap-3 mb-4">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-gray-900 mb-1">Failed Payments</h3>
