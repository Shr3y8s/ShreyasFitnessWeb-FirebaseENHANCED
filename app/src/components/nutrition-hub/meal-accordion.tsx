                ...
                >
                  {editingId === item.id ? (
                    <div className="space-y-3">
                      ...
                      <div className="flex gap-2 pt-1">
                        <Button type="button" size="sm" onClick={() => handleEditSave(item.id)} className="flex-1">
                          <Check className="h-4 w-4 mr-1" />
                          Save
                        </Button>
                        <Button type="button" size="sm" variant="outline" onClick={handleEditCancel} className="flex-1">
                          <X className="h-4 w-4 mr-1" />
                          Cancel
                        </Button>
                      </div>
