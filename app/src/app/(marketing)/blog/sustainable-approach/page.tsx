...
const post = getBlogPost('sustainable-approach')!;
...
export default function SustainableApproachBlog() {
  ...
  return (
    <>
      <JsonLd data={jsonLd} />
    <BlogPost title="The Sustainable Approach I Learned After Years of Failure" date="May 8, 2026" sharePath={`/blog/${post.slug}`} prevPost={{ href: '/blog/mind-muscle', title: 'Previous' }} nextPost={{ href: '/blog/nutrition-framework', title: 'Next' }} relatedPosts={relatedPosts}>
