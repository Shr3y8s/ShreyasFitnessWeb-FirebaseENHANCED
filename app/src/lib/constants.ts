...
const LIVE_PLANS = {
  ...
  // QUARTERLY (3-month pre-pay) — minted at live cutover (B1.3) 2026-07-04.
  ONLINE_COACHING_QUARTERLY: 'P-48720835E0191905HNJE4AXA',  // $540/qtr, product PROD-8A5246863N608771L
  COMPLETE_TRANSFORMATION_QUARTERLY: 'P-18941013R8532470FNJE4AXA',  // $675/qtr, product PROD-0YA71868YT116171P
} as const;
